...
============================================
[2,19,4,5,8,1,2,10,11,2,19,20,3,4]
[2,19][4,5,8][1,2,10,11][2,19,20][3,4]

Вар1: [2,19][4,5,8][1,2,10,11][2,19,20][3,4]
--------------
Вар2: [2,19][8][4,5,8][1,2,10,11][2,3,4,5,12,12,12][2,19,20][3,4]
1.[2,19][1ш][3ш][2ш+10,11][4ш+12,12,12][1ш+19,20][2ш]
2.[2,19][]
Вар3: [2,19][8][4,18][1,2,10,11][2,3,4,5,12,12,12][2,19,20][3,4]

Вар4: [2,19][8][4,18][1,2,10,11][2,12,12,12,13,14,14][2,19,20][3,4]
1.[2,19][1ш][1ш+18][1ш+2,10,11][1ш+12,12,12,13,14,14][1ш+19,20][1ш+4]
2.[2,19][18][2,10,11][12,12,12,13,14,14][19,20][4] => +1 шаг
3.[2,19][1ш][1ш+10,11][0ш+12,12,12,13,14,14][0ш+19,20][1ш] => +1 шаг
4.[2,19][10,11][12,12,12,13,14,14][19,20]
5.[2,19][2ш][0ш+12,12,12,13,14,14][0ш+19,20] => +2 шага
6.[2,19][12,12,12,13,14,14][19,20]
7.[2,19][6ш][0ш+19,20] => +6 шагов
8.[2,19][19,20]

Вар4 По шагам:
2,19,8,4,18,1,2,10,11,2,12,12,12,13,14,14,2,19,20,3,4
1.2,19,4,18,2,10,11,12,12,12,13,14,14,19,20,4
2.2,19,18,10,11,12,12,12,13,14,14,19,20
3.2,19,18,11,12,12,12,13,14,14,19,20
4.2,19,12,12,12,13,14,14,19,20
5.2,19,12,12,13,14,14,19,20
6.2,19,12,13,14,14,19,20
7.2,19,13,14,14,19,20
8.2,19,14,14,19,20
9.2,19,14,19,20
10.2,19,19,20
...
По шагам:
1.[2,19,5,8,2,10,11,19,20,4]
2.[2,19,8,10,11,19,20]
3.[2,19,10,11,19,20]
4.[2,19,11,19,20]
5.[2,19,19,20]
...
# >
# test6_1: List[int] = [12, 2, 13, 2, 3, 4, 10, 1, 3, 11, 1, 5, 11]
# run_test(test6_1)
...
# >
# test8_1: List[int] = [1945,323,984,1886,785,1851,398,1423,1452,1453,1454,1474,1311,1757]
# run_test(test8_1)  #7

# test8_2: List[int] = [1682,1945,323,984,1886,346,481,1059,1388,1452,1464,1474,1311,1427,1757,1992]
# run_test(test8_2)  #10
